...
The specification for this class is provided at [its javadoc page](project3_mountain/project3/BST.html).
...
NOTE: there is no real benefit of having a parent reference in a node, so your implementation should not use one. 
